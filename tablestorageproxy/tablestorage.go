...
func (tableStorage *TableStorage) GetTableACL(tableName string) (*gohaveazurestoragecommon.SignedIdentifiers, int) {
...
func (tableStorage *TableStorage) SetTableACL(tableName string, signedIdentifiers *gohaveazurestoragecommon.SignedIdentifiers) int {
...
func (tableStorage *TableStorage) GetTableServiceProperties() (*gohaveazurestoragecommon.StorageServiceProperties, int) {
...
func (tableStorage *TableStorage) SetTableServiceProperties(storageServiceProperties *gohaveazurestoragecommon.StorageServiceProperties) int {
...
func (tableStorage *TableStorage) GetTableServiceStats() (*gohaveazurestoragecommon.StorageServiceStats, int) {
...
func (tableStorage *TableStorage) QueryEntity(tableName string, partitionKey string, rowKey string, selects string) ([]byte, int) {
...
func (tableStorage *TableStorage) QueryEntities(tableName string, selects string, filter string, top string) ([]byte, int) {
...
func (tableStorage *TableStorage) InsertEntity(tableName string, json []byte) int {
	_, httpStatusCode := tableStorage.http.Request("POST", tableName, "", json, false, true, false, false)
	return httpStatusCode
}

func (tableStorage *TableStorage) DeleteEntity(tableName string, partitionKey string, rowKey string) int {
	_, httpStatusCode := tableStorage.executeEntityRequest("DELETE", tableName, partitionKey, rowKey, nil, true)
	return httpStatusCode
}

func (tableStorage *TableStorage) UpdateEntity(tableName string, partitionKey string, rowKey string, json []byte) int {
	_, httpStatusCode := tableStorage.executeEntityRequest("PUT", tableName, partitionKey, rowKey, json, true)
	return httpStatusCode
}

func (tableStorage *TableStorage) MergeEntity(tableName string, partitionKey string, rowKey string, json []byte) int {
	_, httpStatusCode := tableStorage.executeEntityRequest("MERGE", tableName, partitionKey, rowKey, json, true)
	return httpStatusCode
}

func (tableStorage *TableStorage) InsertOrMergeEntity(tableName string, partitionKey string, rowKey string, json []byte) int {
	_, httpStatusCode := tableStorage.executeEntityRequest("MERGE", tableName, partitionKey, rowKey, json, false)
	return httpStatusCode
}

func (tableStorage *TableStorage) InsertOrReplaceEntity(tableName string, partitionKey string, rowKey string, json []byte) int {
...
func (tableStorage *TableStorage) CreateTable(tableName string) int {
...
func (tableStorage *TableStorage) DeleteTable(tableName string) int {
	_, httpStatusCode := tableStorage.http.Request("DELETE", "Tables%28%27"+tableName+"%27%29", "", nil, false, false, true, false)
	return httpStatusCode
}

func (tableStorage *TableStorage) QueryTables() ([]byte, int) {
